...
def _wrap_llm_call(wrapped, instance, args, kwargs):
    ...
    try:
        ...
        try:
            s = Step(run_id=run_id, api_key=_resolved_api_key, tcc_url=_resolved_tcc_url)
...
def _before_tool_call_hook(context):
    ...
    try:
        ...
        tc = ToolCall(run_id=run_id, tool_name=context.tool_name, api_key=_resolved_api_key, tcc_url=_resolved_tcc_url)
...
def instrument_crewai(
    ...
    global _resolved_api_key, _resolved_tcc_url
    _resolved_api_key = api_key
    _resolved_tcc_url = tcc_url
